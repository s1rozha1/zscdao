      ...
      <div className="container">
        ...
        <section className="about-section">
          ...
          <div className="intro-card">
            <p>Welcome to <strong>zerosupercycle DAO</strong> — a Decentralized Autonomous Organization for everyone passionate about prediction markets and actively trading on Polymarket.</p>
          </div>
